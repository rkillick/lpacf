lpacf.interval <-
            ...
            allpoints = FALSE, verbose=FALSE, ...) 
  {
    ...
    # below has been taken from lacv.fc.leftwp and modified for central rather than left facing filter
    # rest of function
    TT <- length(x)
    ...
    # For interval we don't want to do this as we use different filters at the edges
